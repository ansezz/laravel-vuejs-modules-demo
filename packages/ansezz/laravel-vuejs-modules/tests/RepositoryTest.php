...
use Ansezz\Modules\Collection;
use Ansezz\Modules\Exceptions\InvalidAssetPath;
use Ansezz\Modules\Exceptions\ModuleNotFoundException;
use Ansezz\Modules\Module;
...
class RepositoryTest extends BaseTestCase
{
    ...
    {
        parent::setUp();
        $this->repository = new \Ansezz\Modules\Laravel\Repository($this->app);
    }
    ...
    public function it_gets_the_configured_stubs_path_if_enabled()
    {
        ...
        $this->assertEquals(base_path('vendor/ansezz/laravel-vuejs-modules/src/Commands/stubs'), $this->repository->getStubPath());
    }
